		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Allocation User Management",
									"targetURL": "#comallocusermgmtallocusermgmt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comallocusermgmtallocusermgmt-display": {
								"semanticObject": "comallocusermgmtallocusermgmt",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.alloc.user.mgmt.allocusermgmt",
									"url": sap.ui.require.toUrl("com/alloc/user/mgmt/allocusermgmt")
								}
							}
						}
					}
